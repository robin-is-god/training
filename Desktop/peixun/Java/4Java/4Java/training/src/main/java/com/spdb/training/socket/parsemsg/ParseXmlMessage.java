...
//		try {
//			// 1，报文准备
//			String fileToString = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><reqService><reqHeader><tranCode>TS01</tranCode><transDate>20190619</transDate><sysId>0515</sysId><addr>ss</addr></reqHeader><body><globalSeq>23</globalSeq><transSeq>233</transSeq><transDate>20190619</transDate><name>zs</name><age>19</age><telNo>32</telNo></body></reqService>";
...
//
//			// map to javabean
//			ReqTS01Service reqTS01Service = (ReqTS01Service) ReflectParseUtils.mapToObject((Map<String, Object>) readAssignMsg2Map.get("reqService"), ReqTS01Service.class);
//			System.out.println("..：" + reqTS01Service.getBody().getAge().toString());
//
//			// map to javabean 1
//			AbsAtomicTransService<ReqTS01Service, RspTS01Service> transTS01Service = new TransTS01Service();
...
//
//			xmlSocketTransService.handlerBussiness("TS01", (Map<String, Object>) readAssignMsg2Map.get("reqService"));
//
//		} catch (Exception e) {
